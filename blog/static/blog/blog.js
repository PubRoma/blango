class PostRow extends React.Component {
  render () {
    ...
    return <tr>
      ...
      <td>{post.slug}</td>
      <td>{post.summary}</td>
      <td><a href={'/posts/' + post.slug + '/'}>View</a></td>
    </tr>
  }
}
      ...
      results: [
        {
          ...
          'hero_image': {
            'thumbnail': '/media/__sized__/hero_images/photo_2022-10-18_17-25-09-thumbnail-100x100-70.jpg',
            'full_size': '/media/hero_images/photo_2022-10-18_17-25-09.jpg'
          },
          title: 'Test Post',
          slug: 'test-post',
